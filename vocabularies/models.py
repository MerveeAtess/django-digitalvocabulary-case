...
* sözcüklerin içerisine yeni kelimeleri ekleme
* farklı kategorilerile atayabildikleri kısım
* kullanıcılaın farklı kullanıcıların kullandığı kelimeleri görüp kendine ekleyebilir
"""

# kullanıcıların sözcüklerini temsil eden model
